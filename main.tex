...
The Lean proof script for the Gauss summation identity is provided in Listing \ref{lst:gauss_code}. The proof script expresses the approach taken by the human-oriented proof in the LEAN language. This script is sometimes referred to as the \textit{tactic} script, as, rather than being a proof itself, it describes how the LEAN proof elaborator should build the formal proof. 
